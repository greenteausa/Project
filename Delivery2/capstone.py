...
def encode(data):
  ...
  for col in cat_columns:
    ...
    data[col] = lbn.fit_transform(data[col])
  return data
...
imp_data['Which of the following best describes your work position?'].isna().sum()

tech_list = []
tech_list.append(imp_data[imp_data['Which of the following best describes your work position?'].str.contains('Back-end')]['Which of the following best describes your work position?'].tolist())
tech_list.append(imp_data[imp_data['Which of the following best describes your work position?'].str.contains('Front-end')]['Which of the following best describes your work position?'].tolist())
tech_list.append(imp_data[imp_data['Which of the following best describes your work position?'].str.contains('Dev')]['Which of the following best describes your work position?'].tolist())
tech_list.append(imp_data[imp_data['Which of the following best describes your work position?'].str.contains('DevOps')]['Which of the following best describes your work position?'].tolist())

flat_list = [item for sublist in tech_list for item in sublist]
flat_list = list(dict.fromkeys(flat_list))

imp_data['tech_flag'] = imp_data['Which of the following best describes your work position?']
...
prep_data['tech_flag']=prep_data['Which of the following best describes your work position?']
